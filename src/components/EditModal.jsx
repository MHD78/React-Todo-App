...
const EditModal = ({ todo, edit, setEdit, onEdit }) => {
    ...
    return (
        <form onSubmit={submitHandler} className={`text-sm justify-center w-full h-full items-center gap-x-2  right-0 top-0 bg-black/80 rounded  absolute ${edit ? "flex" : "hidden"}`} >

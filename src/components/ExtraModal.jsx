...
const ExtraModal = ({ modal, setModal, setEdit, todo, onDelete }) => {
    ...
    return (
        <div className={`flex-col dark:bg-black/70 dark:backdrop-blur-md bg-gray-100 absolute top-1 right-4 w-20 rounded-lg p-1 m-1  ${modal ? " flex" : "hidden"}`} >
            <BiX onClick={() => setModal(false)} className="hover:text-red-700 text-lg self-end cursor-pointer" />
            <span  >
